...
from src.parser.text_parser import extract_markdown_images, extract_markdown_links
...
class TestExtractionMarkdownImagesAndLinks(unittest.TestCase):
    ...
    def test_extract_markdown_links(self):
        ...
        self.assertListEqual([("Utsav Deep", "https://utsavdeep.com")], matches)

    def test_extract_markdown_links_no_text(self):
        matches = extract_markdown_links(
            "This is text with an [](https://utsavdeep.com)"
        )
        self.assertListEqual([("", "https://utsavdeep.com")], matches)
